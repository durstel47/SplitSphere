...
namespace SMI
{
    ...
    public partial class SMIGazeController : MonoBehaviour
    {
        ...
        {
            get { return isSimulationModeActive; }
            set { isSimulationModeActive = value; }
        }

        public bool GazeFilterEnabled
        {
            get { return gazeFilterEnabled; }
            set { gazeFilterEnabled = value; }
        }

        public LayerMask DefaultLayerForGazeSelection
        {
            get { return defaultLayerForGazeSelection; }
            set { defaultLayerForGazeSelection = value; }
        }
        #endregion
        ...
        private bool gazeFilterEnabled;

        // Layers for the Gazeinteraction
        private LayerMask defaultLayerForGazeSelection;
        ...
        void Awake()
        {
            ...
            if (!instance)
            {
                ...
                GameObject loadingScreen = Resources.Load("SMILoadingScreen") as GameObject;
                GameObject screen = GameObject.Instantiate(loadingScreen, Vector3.zero, transform.rotation) as GameObject;
                screen.name = screen.name.Replace("(Clone)", "");
                ...
                screen.transform.SetParent(this.gameObject.transform);
                //screen.transform.parent = calibrationCamera.transform;
                screen.transform.SetParent(calibrationCamera.transform);
			...
			{
				Debug.Log ("Awake SMIGazeController NR:" + nr.Message);
			}
#else
        ...
        void OnApplicationQuit()
        {
            ...
            {
                m_SampleCallback = null;
                SMICalibrationVisualizer.Instance.closeVisualization();
            }
            smi_QuitApplication();
        }
        ...
        {
            return Physics.Raycast(smi_getRayFromGaze(), out hitInfo, maxRayCastDistance,defaultLayerForGazeSelection);
        }
        ...
        {
            //override the Setup that the Unity internal CalibrationView is used (and not the basic Visualisation of the Calibration) 
            calibrationClass.client_visualisation = true; 
            ...
            if (calibrationClass.calibrationPointList.Count != 0)
            {
                ...
                // Handle error and print it into the console/logfile
                else
                {
            ...
            // Activate the calibration visualisation; per default it is false -> the internal calibration visualisation will be used
        ...
        private unsafe void smi_startStreaming()
        {
            ...
            parameter.disableGazeFilter = !gazeFilterEnabled;
