...
public class SMITurnToCamera : MonoBehaviour {
    ...
    void Awake()
    {
        ...
        lookAtTarget = calibrationCamera.GetComponent<Camera>().transform;

        foreach(Transform t in transform)
        {
            t.gameObject.layer =  LayerMask.NameToLayer("CalibrationView");
        }
    }
